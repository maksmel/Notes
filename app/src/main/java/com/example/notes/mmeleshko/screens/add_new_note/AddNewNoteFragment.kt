...
import com.example.notes.mmeleshko.R
import com.example.notes.mmeleshko.R.id.action_addNewFragment_to_mainFragment
import com.example.notes.mmeleshko.databinding.FragmentAddNewNoteBinding
import com.example.notes.mmeleshko.models.AppNote
import com.example.notes.mmeleshko.utilits.APP_ACTIVITY
import com.example.notes.mmeleshko.utilits.showToast
        ...
        mBinding.btnAddNote.setOnClickListener {
            ...
            if (name.isEmpty()) {
                ...
                mViewModel.insert(AppNote(name = name, text = text)) {
                    APP_ACTIVITY.navController.navigate(action_addNewFragment_to_mainFragment)
                }
            }
        }
    }
